...
drop table if exists amigos_bloqueados cascade;
...
create table amigos_bloqueados (
    id_usuario1 bigint not null,
    id_usuario2 bigint not null
);

alter table amigos_bloqueados add constraint fk_amigos_bloqueados_id_usuario1 foreign key (id_usuario1) references usuario;
alter table amigos_bloqueados add constraint fk_amigos_bloqueados_id_usuario2 foreign key (id_usuario2) references usuario;
...
alter table mensagem add constraint fk_mensagem_id_anexo foreign key (id_anexo) references anexo;
alter table mensagem add constraint fk_mensagem_id_chat foreign key (id_chat) references chat on delete cascade;
