...
public interface MensagemRepository extends JpaRepository<Mensagem, Long> {
    ...
    @Query(value = "Select * from mensagem as m where m.id_usuario in " +
            "(select c1.id_usuario from chat as c1 where c1.id_usuario = :usuarioId and c1.id_destinatario = :amigoId or " +
