  ...
  return (
    ...
    >
      <div className="Classroom-container">
        <div className="Classroom-exit">
          <button
            className="button-black button-small"
            onClick={() => setSelectedClassroomWork(null)}
          >
            X
          </button>
        </div>
        <div className="Classroom-content">
          <div className="Classroom-item">
            <label> Titulo: </label>
            <blockquote id="classroom-tit">
              {selectedClassroomWork?.title}
            </blockquote>
          </div>
          <div className="Classroom-item">
            <label> Descrição: </label>
            <blockquote id="classroom-desc">
              {selectedClassroomWork?.description
                ? selectedClassroomWork.description
                : "Não há descrição para esta atividade..."}
            </blockquote>
          </div>
          <div className="Classroom-item">
            <label> Link: </label>
            <blockquote className="link">
              <a href={selectedClassroomWork?.alternateLink}>
                {" "}
                {selectedClassroomWork?.alternateLink}{" "}
              </a>
            </blockquote>
          </div>
        </div>
