...
import { useAnexoModal, useGlobalLoading } from "../../../globalState/globalState"
    ...
    const returnRenderAnexo = () => {
        if (anexo) {
          if (anexo.type.includes("video")) {
            return <video src={anexo.anexo} controls className="AnexoFile-file"></video>;
